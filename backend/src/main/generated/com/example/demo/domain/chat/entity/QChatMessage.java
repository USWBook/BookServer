...
public class QChatMessage extends EntityPathBase<ChatMessage> {
    ...
    private static final long serialVersionUID = 1854149898L;
    ...
    public QChatMessage(Class<? extends ChatMessage> type, PathMetadata metadata, PathInits inits) {
        ...
        this.sender = inits.isInitialized("sender") ? new com.example.demo.domain.user.entity.QUser(forProperty("sender"), inits.get("sender")) : null;
    }
